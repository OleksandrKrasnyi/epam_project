...
def articles():
    # Create cursor
    conn = psycopg2.connect(host="ec2-54-75-150-32.eu-west-1.compute.amazonaws.com", dbname="dahfislpfl58c2", user="tnyjbxitavzbld", password="cf1cc3c90602b68d9f8f2ec33b35bf4b2439975eec5771c2700f097c0bb5902a")
